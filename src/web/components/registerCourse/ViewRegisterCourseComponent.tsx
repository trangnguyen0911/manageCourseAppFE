 ...
 */
const ViewRegisterCourseComponent: React.FC<IRegisterCourse> = (props) => {
        ...
        <div className="site-card-border-less-wrapper">
            <Card title="Registration Detail" bordered={false} style={{ width: '95%'}}>
                ...
                <Row  style={{ marginTop: '30px' }}>
                    <Popconfirm placement="top" title={"Are you sure to back to the list?"} onConfirm={() => history.push("/registeredCourses/all")} okText="Yes" cancelText="No">
...
export default ViewRegisterCourseComponent